...
public class add9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MainAdapter(add9.this, dataList);
        ...
        button2.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intentBack = new Intent(add9.this, add9.class);
    ...
    public void AddProduct() {
        Intent intentIntj = new Intent(add9.this, AddProduct.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(add9.this, MainActivity2.class);
        startActivity(intentBack);
        overridePendingTransition(R.anim.fadein, R.anim.fadeout); // 화면 전환 애니메이션
        finish();
    }
