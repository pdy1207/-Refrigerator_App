...
public class add2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MainAdapter(add2.this, dataList);
        ...
        button2.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intentBack = new Intent(add2.this, add2.class);
    ...
    public void AddProduct() {
        Intent intentIntj = new Intent(add2.this, AddProduct.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(add2.this, MainActivity2.class);
        startActivity(intentBack);
        overridePendingTransition(R.anim.fadein, R.anim.fadeout); // 화면 전환 애니메이션
        finish();
    }
