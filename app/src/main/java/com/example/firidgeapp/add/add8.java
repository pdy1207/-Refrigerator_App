...
public class add8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MainAdapter(add8.this, dataList);
        ...
        button2.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intentBack = new Intent(add8.this, add8.class);
    ...
    public void AddProduct() {
        Intent intentIntj = new Intent(add8.this, AddProduct.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intentBack = new Intent(add8.this, MainActivity2.class);
        startActivity(intentBack);
        overridePendingTransition(R.anim.fadein, R.anim.fadeout); // 화면 전환 애니메이션
        finish();
    }
